...
public class MySaTokenConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(new SaRouteInterceptor((request, response, handler) -> {
            ...
            SaRouterUtil.match(Arrays.asList("/**"), Arrays.asList("/user/doLogin", "/","/sa-resources/**","/login.html","/favicon.ico","/static/**","/user/userRegister","/user/getRegisterTprRoleList","/userRegister.html","/user-update.html"), () -> StpUtil.checkLogin());
            // 权限认证 -- 不同模块, 校验不同权限
